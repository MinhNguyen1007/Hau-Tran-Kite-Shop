...
export const SECTIONS = ['category', 'promo', 'guide', 'trust'] as const
export type Section = (typeof SECTIONS)[number]

export const SECTION_LABEL: Record<Section, string> = {
  category: 'Danh mục diều',
  promo: 'Khuyến mãi',
...
export const SECTION_HINT: Record<Section, string> = {
  category: 'Ô vuông cam giữa trang chủ. Dùng: tiêu đề, icon, đường dẫn.',
  promo: 'Dải khuyến mãi. Dùng: tiêu đề, dòng chữ vàng, mô tả, đường dẫn. Khối đầu tiên hiện to gấp đôi.',
  guide: 'Thẻ kinh nghiệm cuối trang chủ. Dùng: tiêu đề, mô tả, icon. Bỏ trống đường dẫn thì thẻ không bấm được.',
